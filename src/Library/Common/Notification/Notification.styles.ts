...
export const NotificationContanier = styled.div<{ type?: string }>`
	display: flex;
	width: 100%;
...
export const NotificationTittle = styled.p<{ type?: string }>`
...
export const NotificationCaptoin = styled.p<{ type?: string }>`
	font-variant-numeric: lining-nums proportional-nums;
