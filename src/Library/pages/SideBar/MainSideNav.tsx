...
import { MAinSideBarAr, MAinSideBarEn } from "../../../../messages/MainSideBar/MAinSideBar";
import BookMark from "@/Library/Common/Icongraphy/BookMark/BookMark";
import Certification from "@/Library/Common/Icongraphy/Certification/Certification";
import Home from "@/Library/Common/Icongraphy/Home/Home";
	...
	return (
		<>
			<SideBar locale={locale}>
				<SideNavShell $direction={"column"} $justify={"space-between"}>
					<div>
						<MainLogo href={"/"}>
							{!isOpen ? (
								<svg
						...
						<SideBarItem href={"/"} icon={<Home />} title={t.myLearning} />
						{/*<SideBarItem href={"/exams"} icon={<ExamIcon />} title={t.exams} />*/}
						<SideBarItem href={"/history"} icon={<RoadIcon />} title={t.examHistory} />
						<SideBarItem href={"/Bookmarks"} icon={<BookMark />} title={t.bookmarks} />
						<SideBarItem href={"/Certificates"} icon={<Certification />} title={t.certificates} />
					</div>
					<div>
						<SideBarItem href={"/settings"} icon={<LineSetting />} title={t.setting} />
						<div className={"divider"} />
						<SideBarItem href={"/support"} icon={<LeadIcon />} title={t.support} />
					</div>
				</SideNavShell>
			</SideBar>
		</>
