...
import {
	SettingsSideNavTranslationAr,
	SettingsSideNavTranslationEn,
} from "../../../../messages/Settings/SettingsSideNav";
...
import LimeLocation from "@/Library/Common/Icongraphy/LimeLocation/LimeLocation";
import LimeUser from "@/Library/Common/Icongraphy/LimeUser/LimeUser";
import LineSocial from "@/Library/Common/Icongraphy/LineSocial/LineSocial";
import PasswordIcon from "@/Library/Common/Icongraphy/PasswordIcon/PasswordIcon";
import Subscription from "@/Library/Common/Icongraphy/Subscribtion/Subscription";
...
const SettingsSideNav = ({ locale }: { locale: string }) => {
	const t = locale === "en" ? SettingsSideNavTranslationEn : SettingsSideNavTranslationAr;

	// const t = locale === "en" ? MAinSideBarEn : MAinSideBarAr;
		...
		<>
			<SideBar locale={locale}>
				...
				<CustomLink
					...
					Label={t.dashboard}
				/>
				<SideBarItem href={"/settings"} icon={<LimeUser />} title={t.profile} />
				<SideBarItem href={"/settings/invoices"} icon={<Invoice />} title={t.invoice} />
				<SideBarItem href={"/settings/password"} icon={<PasswordIcon />} title={t.password} />
				<SideBarItem href={"/settings/address"} icon={<LimeLocation />} title={t.address} />
				<SideBarItem href={"/settings/social"} icon={<LineSocial />} title={t.social} />
				{/*<SideBarItem href={"/settings/notification"} icon={<LimeBell />} title={t.notification} />*/}
				<SideBarItem
