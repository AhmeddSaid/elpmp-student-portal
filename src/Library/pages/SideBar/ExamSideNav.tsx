...
import { ExamSideNavAr, ExamSideNavEn } from "../../../../messages/ExamSideNav/ExamSideNav";
...
const ExamSideNav = ({ locale }: { locale: string }) => {
	const t = locale === "en" ? ExamSideNavEn : ExamSideNavAr;
	...
	return (
		<>
			<SideBar locale={locale}>
				...
				<SideBarItem href={"/admin/promo"} icon={<HomeIcon />} title={t.promo} />
				<SideBarSubTitle body={"Questions"} />
				<SideBarItem href={"/admin/exams/question"} icon={<HomeIcon />} title={t.question} />
			</SideBar>
		</>
	);
};
