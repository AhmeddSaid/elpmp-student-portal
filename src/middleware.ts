...
`;
	...
	const token: string | boolean = request.cookies.get("pmp_db_userId")?.value || false;
	const isAuthRoute: boolean =
		request.nextUrl.pathname.startsWith("/auth/login") ||
		request.nextUrl.pathname.startsWith("/en/auth/login") ||
		request.nextUrl.pathname.startsWith("/ar/auth/login") ||
		request.nextUrl.pathname.startsWith("/auth/register") ||
		request.nextUrl.pathname.startsWith("/en/auth/register") ||
		request.nextUrl.pathname.startsWith("/ar/auth/forgot-password") ||
		request.nextUrl.pathname.startsWith("/en/auth/forgot-password") ||
		request.nextUrl.pathname.startsWith("/auth/forgot-password") ||
		request.nextUrl.pathname.startsWith("/ar/auth/forgot-password") ||
		request.nextUrl.pathname.startsWith("/en/auth/reset-password") ||
		request.nextUrl.pathname.startsWith("/auth/reset-password") ||
		request.nextUrl.pathname.startsWith("/auth/verify") ||
		request.nextUrl.pathname.startsWith("/en/auth/verify") ||
		request.nextUrl.pathname.startsWith("/ar/auth/verify") ||
		request.nextUrl.pathname.startsWith("/ar/auth/register");
